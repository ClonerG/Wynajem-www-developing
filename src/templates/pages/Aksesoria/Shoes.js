        ...
        <div class="sh-second-field">
          ...
          <div class='sh-second-img-block'>
            <div class='sh-second-img-bloc sh-border'>
              ...
              <form class='sh-form'>
                <input type="email" placeholder='Enter your email here' class='sh-input' />
